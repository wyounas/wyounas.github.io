...
Here is the program followed by the trail that shows the extreme interleaving (statements in PROMELA are atomic (PROMELA is a simple language used for writing models in SPIN) are atomic):
